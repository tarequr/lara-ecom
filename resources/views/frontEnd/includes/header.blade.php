		...
		<div class="container">
			<div class="header-left header-dropdowns">
				<div class="header-dropdown">
					<a href="#" class="pl-0"><img src="{{ asset('public/frontEnd/assets/images/flags/en.png') }}" alt="England flag">ENG</a>
					<div class="header-menu">
						<ul>
							<li><a href="#"><img src="{{ asset('public/frontEnd/assets/images/flags/en.png') }}" alt="England flag">ENG</a></li>
							<li><a href="#"><img src="{{ asset('public/frontEnd/assets/images/flags/fr.png') }}" alt="France flag">FRA</a></li>
						</ul>
					</div><!-- End .header-menu -->
		...
		<div class="container">
			...
			<div class="header-center order-first order-lg-0 ml-0 ml-lg-auto">
				...
				<a href="index-2.html" class="logo">
					<img src="{{ asset('public/frontEnd/assets/images/logo.png') }}" alt="Porto Logo">
				</a>
			...
			<div class="header-right w-lg-max ml-0 ml-lg-auto">
				...
				<a href="{{ route('show.wishlist') }}" class="header-icon pl-1 pr-2">
					...
					<div class="dropdown-menu">
						<div class="dropdownmenu-wrapper">
							<div class="dropdown-cart-header">
								...
								<a href="{{ route('show.cart') }}" class="float-right">View Cart</a>
								...
								<div class="product">
									...
									<figure class="product-image-container">
										<a href="#" class="product-image">
											<img src="{{ asset('public/upload/product_images/'.$product->options->image) }}" alt="product" width="80" height="80">
										</a>
										<a href="{{ route('delete.cart',$product->rowId) }}" class="btn-remove icon-cancel" title="Remove Product"></a>
									</figure>
								</div><!-- End .product -->
							...
							<div class="dropdown-cart-action">
								...
								@elseif(@Auth::user()->id !==NULL && Session::get('shippingId') != NULL)
                                    <a href="{{ route('customer.payment') }}" class="btn btn-dark btn-block">Checkout</a>
								@else
                                    <a href="{{ route('customer.login') }}" class="btn btn-dark btn-block">Checkout</a>
								@endif
							</div><!-- End .dropdown-cart-total -->
				...
				<ul class="menu">
						...
						<div class="megamenu megamenu-fixed-width">
							<div class="row">
								...
								<div class="col-lg-3 p-0">
									<img src="{{ asset('public/frontEnd/assets/images/menu-bg.png') }}" alt="Menu banner" class="product-promo">
								</div><!-- End .col-lg-4 -->
							</div><!-- End .row -->
						</div><!-- End .megamenu -->
					</li>
					<li>
						...
						<ul>
							...
							<li><a href="{{ route('customer.login') }}" class="login-link">Login</a></li>
